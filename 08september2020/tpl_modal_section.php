...
>>>>>>> aafb8d78ecea70eaa6b8ca375ae780844fa38039
</style>
...
=======
           <img style="width: 80%;" src="images/smart-feature.png" alt="">
       </div>
       <div style="width: 80%;" class="col-md-6">
          <div class="text-bg">
>>>>>>> aafb8d78ecea70eaa6b8ca375ae780844fa38039
...
=======
<img src="images/Vector.png" alt="" width="30px" height="30px" style="margin-right: 20px;">
>>>>>>> aafb8d78ecea70eaa6b8ca375ae780844fa38039
</button>
...
<<<<<<< HEAD
        ...
        <form  id="contact_form" action="" method="post">
          ...
          <input type="text" id="mobile" name="mobile" placeholder="Enter your 10-digit Number" >
...
<<<<<<< HEAD
          ...
          <textarea id="message" name="message" placeholder="Tell us your concern" style="height: 80px;" ></textarea>
...
=======
          ...
          <textarea id="subject" name="subject" placeholder="Tell us your concern" style="height: 80px;width: 135%;"></textarea>

          <input data-dismiss="modal" data-toggle="modal" data-target="#portfolioModal6" type="submit" value="Submit">
        </form>
      </div>
      <div class="col-md-6">
        <img class="img-hidden" style="width: 100%;margin: 120px 0px 0px 25px;" src="images/Group.png">
>>>>>>> aafb8d78ecea70eaa6b8ca375ae780844fa38039
      </div>
      <!-- form sbmit -->
    </div>
...
=======
      <img style="width: 140px;margin-bottom:16px;" src="images/Group-2.png">
...
<script>
  $(document).ready(function(){
    ...
    jQuery( "#submit" ).click(function() {
     //jQuery('#portfolioModal6').modal('show');
      //alert(form.validate());
        if(form.validate()){
          //$('#portfolioModal6').modal('show');
          //$('#portfolioModal1').modal('hide');
            /*$.ajax({
                url: fundRequestApprove,
                type: 'POST',
                data: {
                    'name': id,
                    'mobile': id,
...
<script>
 $(document).ready(function(){
   $("#portfolioModal1,#portfolioModal6").modal({
      show:false,
      backdrop:'static'
    });
});
