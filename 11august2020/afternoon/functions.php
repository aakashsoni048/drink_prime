...
// add for shortcode page start


function my_form_shortcode() {
   include( get_stylesheet_directory() . '/tpl_modal_section.php' );
} 
add_shortcode( 'my_form_shortcode1', 'my_form_shortcode' );

// Shortcode to output custom PHP in Elementor
function wpc_elementor_shortcode( $atts ) {
    echo get_template_part('tpl_modal_section.php');
}
add_shortcode( 'my_elementor_php_output', 'wpc_elementor_shortcode');
// add for shortcode page end
...
function my_custom_fonts() {
  echo '<style>
   			#toplevel_page_elementor ul.wp-submenu li:nth-child(10), #toplevel_page_elementor ul.wp-submenu li:nth-child(11){
				display:none;		
			}
  </style>';
}